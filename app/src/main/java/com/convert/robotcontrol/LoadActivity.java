...
public class LoadActivity extends AppCompatActivity implements LoadCallBack{
    ...
    private String mPing = "ping -c 1 -w 1 ";// 其中 -c 1为发送的次数，-w 表示发送后等待响应的时间
            ...
            public void run() {
                ...
                for (int i = 1; i < 255; i++) {// 创建256个线程分别去ping
                    ...
                    Runnable run = new Runnable() {
                        ...
                        @Override
                        public void run() {
                            String ping = LoadActivity.this.mPing + mLocAddress + lastAddress;
            ...
            switch (msg.what) {
                case MSG_PROGRESS:
                    ...
                    if (mProgress == MAX_PROGRESS){
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<String>(LoadActivity.this,android.R.layout.simple_list_item_1,mIpList);
